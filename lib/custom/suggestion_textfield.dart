...
class _TypeAheadFieldState<T> extends State<SuggestionField<T>>
  ...
  Widget build(BuildContext context) {
    return CompositedTransformTarget(
      ...
      child: ExtendedTextField(
        ...
        controller: this._effectiveController,
        specialTextSpanBuilder: widget.textFieldConfiguration.spanBuilder,
...
class TextFieldConfiguration<T> {
  ...
  final SpecialTextSpanBuilder spanBuilder;
...
class _SuggestionsBox {
  ...
  void _adjustMaxHeightAndOrientation() {
    SuggestionField widget = context.widget as SuggestionField;
