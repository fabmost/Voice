...
class HeaderPromoPoll extends StatelessWidget with ShareContent {
  ...
  HeaderPromoPoll(this.pollModel);
  ...
  void _share(context) {
    ...
    sharePromoPoll(context, pollModel.id, pollModel.title, image);
  }
