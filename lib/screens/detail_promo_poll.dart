...
import '../widgets/header_promo_poll.dart';
...
class DetailPromoPollScreen extends StatefulWidget {
  static const routeName = '/promo-poll';

  final String id;

  DetailPromoPollScreen({this.id});

  @override
  _DetailPollScreenState createState() => _DetailPollScreenState();
}

class _DetailPollScreenState extends State<DetailPromoPollScreen> {
                  ...
                  child: RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        if (i == 0) {
                          return HeaderPromoPoll(_pollModel);
                        }
